...
export async function onRequestPost({ request, env }) {
  try {
    ...
    form.set("success_url", `${env.PUBLIC_SITE_URL}/pay/?session_id={CHECKOUT_SESSION_ID}`);
    form.set("cancel_url", `${env.PUBLIC_SITE_URL}/pay/?id=${quote.id}&token=${encodeURIComponent(data.token)}`);
